...
import useIsMobile from '../dependencies/hooks/useIsMobile';
import useIsTab from '../dependencies/hooks/useIsTab';
import ECommercePanel from '../dependencies/interactive-live-streaming/components/ECommercePanel';
import EProductDetailPanel from '../dependencies/interactive-live-streaming/components/EProductDetailPanel';
import VoucherPanel from '../dependencies/interactive-live-streaming/components/VoucherPanel';
import SharePanel from '../dependencies/interactive-live-streaming/components/SharePanel';
import CreatePoll from '../dependencies/interactive-live-streaming/components/pollContainer/CreatePoll';
import PollList from '../dependencies/interactive-live-streaming/components/pollContainer/PollList';
import SubmitPollList from '../dependencies/interactive-live-streaming/components/pollContainer/SubmitPollList';
import { sideBarModes } from '../dependencies/utils/common';
import { XIcon } from '@heroicons/react/outline';
import { ChatPanel } from './ChatPanel';
import { ParticipantPanel } from './ParticipantPanel';
import { Dialog, Transition } from '@headlessui/react';
import { useMediaQuery } from 'react-responsive';
import { useMeetingAppContext } from '../dependencies/MeetingAppContextDef';
...
const SideBarTabView = ({
  ...
  return (
    ...
    >
      <div>
        <div
          className="bg-gray-750 rounded-md"
          style={{
            height: '100%',
            // borderRadius: 10,
            overflow: 'hidden',
