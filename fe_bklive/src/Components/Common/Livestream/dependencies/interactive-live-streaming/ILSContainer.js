...
import { PresenterView } from '../../../Livestream/PresenterView';
...
export function ILSContainer({
  ...
  // const meetingSection = useRef(null);
  ...
  return (
    ...
    <div className="h-60vh ils-container">
      {/* //change here */}
      <div
        ref={containerRef}
        ...
        {typeof localParticipantAllowedJoin === 'boolean' ? (
          localParticipantAllowedJoin ? (
            <>
              ...
              <div
                className={` flex flex-1  flex-row bg-white relative`}
                // id="meeting-section"
              >
                {meetingMode === Constants.modes.CONFERENCE ? (
