...
import { createMeeting, getToken, validateMeeting } from '../dependencies/api';
...
import WebcamOffIcon from '../dependencies/icons/MicOffSmallIcon';
import WebcamOnIcon from '../dependencies/icons/Bottombar/WebcamOnIcon';
import MicOffIcon from '../dependencies/icons/MicOffIcon';
import MicOnIcon from '../dependencies/icons/Bottombar/MicOnIcon';
...
export function JoiningScreen({
  ...
  return (
    <div className="inset-0 h-60vh">
      <div className="overflow-y-auto flex flex-col flex-1 h-full  bg-gray-800">
        <div className="flex flex-1 flex-col md:flex-row items-center justify-center md:m-xl m-16">
